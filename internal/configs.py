...
class   Config:
  ...
  eval_on_train: bool = False  # TODO Naama
  ...
  use_uw_bs_initial_loss: bool = False
  use_uw_sig_obj_loss: bool = False
  uw_initial_bs_loss_mult: float = 0.1
  uw_initial_sig_loss_mult: float = 0.01
  uw_final_bs_loss_mult: float = 0.01
  uw_final_sig_loss_mult: float = 0.01
  uw_usual_rendering : int = 600
  uw_final_usual_rendering: int = 1500
  uw_decay_bs: int = 2000
  uw_decay_sig: int = 5000
  simon_eq: bool = False
  uw_old_model: bool = False
  uw_fog_model: bool = False
  use_uw_sig_med_loss: bool = False
  uw_sig_med_mult: float = 0.01
  depth_loss: bool = False
  depth_mult: float = 1


  # uw_wb_val: Tuple[float] = (0.0395, 0.3078, 0.2639)
  # field(default_factory= [0.0395, 0.3078, 0.2639])
